...
def calculate_word_scores(phraseList):
    ...
    for item in word_frequency:
        ...
        word_score[item] = math.log(word_degree[item] / (word_frequency[item] * 1.0))  # orig.
...
def generate_candidate_keyword_scores(phrase_list, word_score, min_keyword_frequency=1):
    ...
    for phrase in phrase_list:
        ...
        keyword_candidates[phrase] = (1/pow(len(word_list), 0.8))*candidate_score if len(word_list) > 0 else candidate_score
