...
if __name__ == "__main__":
    ...
    # use TCN
    parser.add_argument("--use_tcn", action="store_true", help="Whether to use TCN")
    parser.add_argument('--nhid', type=int, default=400)
    parser.add_argument('--levels', type=int, default=4)
    parser.add_argument('--kernel_size', type=int, default=2)
    parser.add_argument('--dropout_tcn', type=float, default=0.2)

    # use self intention in Intent Dectection
    parser.add_argument("--use_intent_self_attn", action="store_true", help="Whether to use use_intent_self_attn")
    
    # Train NER only
    parser.add_argument("--train_ner_only",action="store_true", help="Whether to train NER only")
